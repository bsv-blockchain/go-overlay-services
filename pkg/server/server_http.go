...
import (
	...
	"github.com/4chain-ag/go-overlay-services/pkg/server/internal/adapters"
	"github.com/4chain-ag/go-overlay-services/pkg/server/internal/ports"
	"github.com/4chain-ag/go-overlay-services/pkg/server/internal/ports/decorators"
	"github.com/4chain-ag/go-overlay-services/pkg/server/internal/ports/middleware"
...
// It returns a Option that applies this configuration to ServerHTTP.
...
// It returns a Option that appends the given middleware to the server's middleware stack.
...
// WithOctetStreamLimit returns a Option that sets the maximum allowed size (in bytes)
...
// Returns a Option to apply during server setup.
