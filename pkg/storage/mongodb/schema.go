...
func (s *Store) schemaFingerprint() string {
	...
	specs := append([]schemaCollectionSpec{{name: schemaCollection, validator: schemaValidator()}}, schemaDataSpecs()...)
